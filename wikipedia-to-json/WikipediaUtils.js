...
wikiUtils.equals = function (article1, article2) {
  var article1Trimmed = article1.toLocaleLowerCase().trim(),
    article2Trimmed = article2.toLocaleLowerCase().trim();
  if (article1Trimmed == article2Trimmed) return true;
  if (
    wikiUtils.friendlyArticleName(article1Trimmed) ==
    wikiUtils.friendlyArticleName(article2Trimmed)
  )
    return true;
